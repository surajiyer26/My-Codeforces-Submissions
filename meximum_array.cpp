...
signed main () {
    ...
    while (t--) {
        ...
        vi vec (n);
        rep (i,0,n) cin >> vec[i];
        int index_size = *max_element(all(vec)) + 1;
        vi index (index_size, 0);
        map <int, int> m;
        rep (i,0,n) m[vec[i]] += 1;
        // for (auto ele: vec) cout << ele << " ";
        // cout << "\n";
        // for (auto ele: index) cout << ele << " ";
        // cout << "\n";
        ...
        rep (i,0,n) {
            index[vec[i]] += 1;
            m[vec[i]] -= 1;
            while (idx < index.size() && index[idx]) idx += 1;
            if (m[idx]) continue;
            else {
                res.pb(idx);
        ...
        // while (true) {
        //     if (idx < index.size() && m[idx] && index[idx] == 0) {
        //         while (vec[it] != idx) {
        //             m[vec[it]] -= 1;
        //             index[vec[it]] += 1;
        //             it += 1;
        ...
        //         it += 1;
        //     }
        //     else if (idx < index.size() && index[idx]) idx += 1;
        //     else if (idx == index.size()) {
        //         vec.pb(idx);
        //         index.clear();
        //         idx = 0;
        //     }
